# Agent guide - cansi-kotlin

This file is the quick-reference operating contract for cansi-kotlin. The longer
...
cansi-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`cansi`](./README.md). Upstream Rust is the behavioral oracle while the
